    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">Data Pesanan Custom</h5>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="pages/pesanan/print-custom.php" method="GET" target="_blank">
...
<script>
    function loadContent() {
        $.ajax({
            url: 'pages/pesanan/table-custom.php',
            type: 'GET',
    ...
    $(document).ready(function () {
        ...
        $('#btn-tambah').on('click', function () {
            ...
            $.ajax({
                url: 'pages/pesanan/tambah-custom.php',
                method: 'post',
                data: { user: user },
                success: function (data) {
                    $('#tampil_data').html(data);
                    document.getElementById("judul").innerHTML = 'Tambah Pesanan';
                }
            });
            $('#modal').modal('show');
        });
