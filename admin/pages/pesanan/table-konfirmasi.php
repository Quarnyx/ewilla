<div class="table-responsive">
    <table class="table table-hover" id="table">
        ...
        <tbody>
            ...
            $sql = mysqli_query($conn, "SELECT * FROM v_paymentconfirm");
            $no = 0;
                ...
                <tr class="single-item">
                    ...
                    <td>
                        <a href="javascript:void(0)" class="hstack gap-3">
                            <div>
                                <span class="text-truncate-1-line"><?php echo $row['customer_name'] ?></span>
                    ...
                    <td><?php echo $row['cust_bank'] ?> | <?php echo $row['cust_bank_name'] ?></td>
                    ...
                    <td>
                        <img src="../assets/img/pembayaran/<?= $row['proof'] ?>" class="img-fluid" alt="image">
                    </td>
                    <td>
                        <div class="hstack gap-2 justify-content-end">
                            <button href="javascript:void(0);" class="avatar-text avatar-md hapus" data-bs-toggle="tooltip"
                                title="Hapus" data-id="<?php echo $row['confirm_id'] ?>" data-bs-original-title="Hapus">
    ...
    $('#table').on('click', '.hapus', function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                console.log(id);
                $.ajax({
                    url: 'process.php?act=hapus-konfirmasi',
                    type: 'POST',
