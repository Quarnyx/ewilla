<div class="table-responsive">
    <table class="table table-hover" id="table">
        ...
        <tbody>
            ...
            $sql = mysqli_query($conn, "SELECT * FROM view_pro_cat");
            $no = 0;
                ...
                <tr class="single-item">
                    ...
                    <td>
                        <div class="hstack gap-2 justify-content-end">
                            ...
                            <a target="_blank" href="?page=variasi-produk&id=<?php echo $row['product_id'] ?>"
                                class="btn btn-primary rounded" data-id="<?php echo $row['product_id'] ?>"
                                data-bs-toggle="tooltip" title="Variasi" data-bs-original-title="Variasi">
                                <i class="feather-edit-3"></i> Tambah Variasi
                            </a>
