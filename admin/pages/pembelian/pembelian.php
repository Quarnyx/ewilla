<div class="nxl-content">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="pages/pembelian/print-pembelian.php" method="GET" target="_blank">
    ...
    <script>
        function loadContent() {
            $.ajax({
                url: 'pages/pembelian/table-pembelian.php',
                type: 'GET',
        ...
        $(document).ready(function () {
            ...
            $('#btn-tambah').on('click', function () {
                ...
                $.ajax({
                    url: 'pages/pembelian/tambah-pembelian.php',
                    method: 'post',
                    data: { user: user },
                    success: function (data) {
                        $('#tampil_data').html(data);
                        document.getElementById("judul").innerHTML = 'Tambah Pembelian';
                    }
                });
                $('#modal').modal('show');
            });
